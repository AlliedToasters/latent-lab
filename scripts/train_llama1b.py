"""
Train truth/falsehood probes on Geometry of Truth datasets using Llama 3.2 1B Instruct.

GTX 1060 6GB — model is ~2.4GB in fp16, should fit.
Expect weaker performance than Qwen models given the small size and
the fact that Llama 1B may not encode factual knowledge as robustly.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train GoT truth probes — Llama 3.2 1B")
    parser.add_argument(
        "--dataset",
        default=None,
