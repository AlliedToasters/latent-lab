"""
Train truth/falsehood probes on Geometry of Truth datasets using Gemma 2 2B IT.

GTX 1060 6GB — model is ~5.2GB in fp16, very tight. May need to fall back
to CPU or a smaller model if OOM occurs.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train GoT truth probes — Gemma 2 2B")
    parser.add_argument(
        "--dataset",
        default=None,
